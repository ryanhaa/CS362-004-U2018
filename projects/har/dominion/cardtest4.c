...
int main () {
    ...
    asserttrue(state.handCount[0],stateOriginal.handCount[0]+3);
    printf("%s\n","Testing numActions" );
    asserttrue(state.numActions,stateOriginal.numActions);
    printf("%s\n","Testing deckCount of player" );
    asserttrue(state.deckCount[0],stateOriginal.deckCount[0]-4);
    printf("%s\n","Testing numBuys" );
    ...
    for (int i = 1; i < state.numPlayers; i++)
    {
        ...
        asserttrue(state.handCount[i],stateOriginal.handCount[i]+1);
