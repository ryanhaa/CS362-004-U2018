...
int main () {
    ...
    asserttrue(state.handCount[0],stateOriginal.handCount[0]+2);
    printf("%s\n","Testing deckCount of player" );
    asserttrue(state.deckCount[0],stateOriginal.deckCount[0]-3);
    printf("%s\n","Testing discardCount of player" );
    asserttrue(state.discardCount[0],stateOriginal.discardCount[0]);
